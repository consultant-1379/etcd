...
{{- define "eric-data-distributed-coordinator-ed.aggregatedMerge" -}}
  {{- $merged := dict -}}
  {{- $context := .context -}}
  {{- $location := .location -}}
...
*/ -}}
{{- define "eric-data-distributed-coordinator-ed.mergeAnnotations" -}}
  {{- include "eric-data-distributed-coordinator-ed.aggregatedMerge" (dict "context" "annotations" "location" .location "sources" .sources) }}
{{- end -}}

{{- define "eric-data-distributed-coordinator-ed.mergeLabels" -}}
  {{- include "eric-data-distributed-coordinator-ed.aggregatedMerge" (dict "context" "labels" "location" .location "sources" .sources) }}
{{- end -}}
